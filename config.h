...
static char *fonts[]          = { "JetBrainsMono Nerd Font:size=11", "monospace:size=11", "NotoColorEmoji:pixelsize=12:antialias=true:autohint=true" };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_n,          spawn,                  {.v = (const char*[]){ "quote-capture", NULL } } },
	...
	{ MODKEY|ControlMask,		XK_F1,         spawn,                  {.v = (const char*[]){ "emacs-cheatsheet", NULL } } },
